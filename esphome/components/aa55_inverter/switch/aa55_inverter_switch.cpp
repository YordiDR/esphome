...
AA55InverterSwitch::AA55InverterSwitch(std::string id, aa55_const::INPUT_TYPE type, AA55Inverter *parent_inverter,
                                       bool offline_hold, aa55_const::ON_OFF offline_value,
                                       aa55_const::ON_OFF online_initial_value)
...
void AA55InverterSwitch::handle_response(aa55_const::FUNCTION_CODE function_code, uint8_t response) {
  if (response != 6) {
