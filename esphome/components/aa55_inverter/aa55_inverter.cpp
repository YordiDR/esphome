...
void AA55Inverter::setup() {
  ...
  aa55_bus::AA55Packet remove_register_command{};
  remove_register_command.source_address = this->parent_bus_->get_controller_address();
...
void AA55Inverter::update() {
  ...
  aa55_bus::AA55Packet query_run_info_command{};
  query_run_info_command.source_address = this->parent_bus_->get_controller_address();
...
void AA55Inverter::handle_packet(const aa55_bus::AA55Packet &packet) {
...
void AA55Inverter::parse_run_info_response(const aa55_bus::AA55Packet &packet) {
...
void AA55Inverter::parse_id_info_response(const aa55_bus::AA55Packet &packet) {
...
void AA55Inverter::parse_execute_response(const aa55_bus::AA55Packet &packet) {
  for (AA55InverterBaseInput *input : this->inputs_) {
...
void AA55Inverter::send_execute_command(aa55_bus::FUNCTION_CODE function_code, uint8_t payload) {
  ESP_LOGD(LOGGING_TAG, "Sending execute command %x with payload %d to inverter %x", function_code, payload,
           this->device_address_);
  aa55_bus::AA55Packet execute_command{};
  execute_command.source_address = this->parent_bus_->get_controller_address();
...
void AA55Inverter::handle_registration_request(const aa55_bus::AA55Packet &packet) {
  ...
  aa55_bus::AA55Packet address_confirm_command{};
  address_confirm_command.source_address = this->parent_bus_->get_controller_address();
...
void AA55Inverter::handle_address_confirm(const aa55_bus::AA55Packet &packet) {
  ...
  aa55_bus::AA55Packet query_id_info_command{};
  query_id_info_command.source_address = this->parent_bus_->get_controller_address();
